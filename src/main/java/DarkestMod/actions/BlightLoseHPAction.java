...
public class BlightLoseHPAction extends AbstractGameAction {
    private static final float DURATION = 0.33F;

    public BlightLoseHPAction(AbstractCreature target, AbstractCreature source, int amount, AttackEffect effect) {
