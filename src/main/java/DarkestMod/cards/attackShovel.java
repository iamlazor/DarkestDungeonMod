...
public class attackShovel extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID("Shovel"); // DefaultMod.makeID("attackNailStrike");

    public static final String IMG = makeCardPath("attackShovel.png");// "public static final String IMG = makeCardPath("attackNailStrike.png");
