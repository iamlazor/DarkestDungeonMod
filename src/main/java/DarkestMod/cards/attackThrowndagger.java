...
public class attackThrowndagger extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("ThrownDagger"); // DefaultMod.makeID("attackNailStrike");

    public static final String IMG = makeCardPath("attackThrowingDaggers.png");// "public static final String IMG = makeCardPath("attackNailStrike.png");
