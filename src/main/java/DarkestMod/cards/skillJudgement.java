...
public class skillJudgement extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("Judgement"); // DefaultMod.makeID("attackNailStrike");
    ...
    public skillJudgement() { // public attackNailStrike() - This one and the one right under the imports are the most important ones, don't forget them
