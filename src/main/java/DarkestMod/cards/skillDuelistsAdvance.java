...
public class skillDuelistsAdvance extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID("Duelists Advance"); // DefaultMod.makeID("attackNailStrike");

    public static final String IMG = makeCardPath("skillDuelist.png");// "public static final String IMG = makeCardPath("attackNailStrike.png");
    ...
    public skillDuelistsAdvance() { // public attackNailStrike() - This one and the one right under the imports are the most important ones, don't forget them
