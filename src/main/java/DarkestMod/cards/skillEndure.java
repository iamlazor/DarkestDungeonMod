...
public class skillEndure extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("Endure"); // DefaultMod.makeID("attackNailStrike");

    public static final String IMG = makeCardPath("skilLEndure.png");// "public static final String IMG = makeCardPath("attackNailStrike.png");
    ...
    public skillEndure() { // public attackNailStrike() - This one and the one right under the imports are the most important ones, don't forget them
