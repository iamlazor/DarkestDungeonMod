...
public class skillBolster extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("Bolster"); // DefaultMod.makeID("attackNailStrike");
    ...
    public skillBolster() { // public attackNailStrike() - This one and the one right under the imports are the most important ones, don't forget them
