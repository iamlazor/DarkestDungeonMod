...
public class skillSnipersMark extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID("Snipers Mark"); // DefaultMod.makeID("attackNailStrike");
