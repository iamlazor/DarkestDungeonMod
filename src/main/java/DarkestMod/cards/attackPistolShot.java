...
public class attackPistolShot extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("Pistol Shot"); // DefaultMod.makeID("attackNailStrike");
