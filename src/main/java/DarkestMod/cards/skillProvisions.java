...
public class skillProvisions extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID("Provisions"); // DefaultMod.makeID("attackNailStrike");

    public static final String IMG = makeCardPath("skillProvisions.png");// "public static final String IMG = makeCardPath("attackNailStrike.png");
