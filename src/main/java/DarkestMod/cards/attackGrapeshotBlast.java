...
public class attackGrapeshotBlast extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID("GrapeshotBlast"); // DefaultMod.makeID("attackNailStrike");

    public static final String IMG = makeCardPath("attackGrapeshotBlast.png");// "public static final String IMG = makeCardPath("attackNailStrike.png");
