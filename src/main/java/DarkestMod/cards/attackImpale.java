...
public class attackImpale extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("Impale"); // DefaultMod.makeID("attackNailStrike");

    public static final String IMG = makeCardPath("attackImpale.png");// "public static final String IMG = makeCardPath("attackNailStrike.png");
    ...
    public attackImpale() { // public attackNailStrike() - This one and the one right under the imports are the most important ones, don't forget them
