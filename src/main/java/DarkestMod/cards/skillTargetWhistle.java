...
public class skillTargetWhistle extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("Target Whistle"); // DefaultMod.makeID("attackNailStrike");
