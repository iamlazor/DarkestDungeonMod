...
public class skillBlock_s extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("skillBlock_s"); // DefaultMod.makeID("attackNailStrike");
    ...
    public skillBlock_s() { // public attackNailStrike() - This one and the one right under the imports are the most important ones, don't forget them
