...
public class skillFlashingDaggers extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("Flashing Daggers"); // DefaultMod.makeID("attackNailStrike");

    public static final String IMG = makeCardPath("skillFlashingDaggers.png");// "public static final String IMG = makeCardPath("attackNailStrike.png");
