...
public class skillProtectMe extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID("Protect Me"); // DefaultMod.makeID("attackNailStrike");

    public static final String IMG = makeCardPath("skillProtectMe.png");// "public static final String IMG = makeCardPath("attackNailStrike.png");
