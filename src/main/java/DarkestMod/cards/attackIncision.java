...
public class attackIncision extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("Incision"); // DefaultMod.makeID("attackNailStrike");

    public static final String IMG = makeCardPath("attackIncision.png");// "public static final String IMG = makeCardPath("attackNailStrike.png");
