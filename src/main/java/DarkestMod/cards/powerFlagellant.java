...
public class powerFlagellant extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID("Flagellant");
    public static final String IMG = makeCardPath("powerTheFlagellant.png");
