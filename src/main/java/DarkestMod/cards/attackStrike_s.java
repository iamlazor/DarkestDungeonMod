...
public class attackStrike_s extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID("attackStrike_s"); // DefaultMod.makeID("attackNailStrike");
    ...
    public attackStrike_s() { // public attackNailStrike() - This one and the one right under the imports are the most important ones, don't forget them
