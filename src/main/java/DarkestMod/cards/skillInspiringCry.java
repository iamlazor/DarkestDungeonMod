...
public class skillInspiringCry extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("Inspiring Cry"); // DefaultMod.makeID("attackNailStrike");
