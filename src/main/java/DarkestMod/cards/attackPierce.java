...
public class attackPierce extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("Pierce"); // DefaultMod.makeID("attackNailStrike");
    ...
    public attackPierce() { // public attackNailStrike() - This one and the one right under the imports are the most important ones, don't forget them
