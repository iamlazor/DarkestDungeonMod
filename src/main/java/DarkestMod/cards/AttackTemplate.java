...
public class AttackTemplate extends AbstractDynamicCard {
    ...
    public static final String ID = DarkestMod.makeID("DefaultCommonAttack"); // DefaultMod.makeID("attackNailStrike");
    ...
    public AttackTemplate() { // public attackNailStrike() - This one and the one right under the imports are the most important ones, don't forget them
