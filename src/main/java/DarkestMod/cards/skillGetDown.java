...
public class skillGetDown extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID("Get Down"); // DefaultMod.makeID("attackNailStrike");

    public static final String IMG = makeCardPath("skillGetDown.png");// "public static final String IMG = makeCardPath("attackNailStrike.png");
