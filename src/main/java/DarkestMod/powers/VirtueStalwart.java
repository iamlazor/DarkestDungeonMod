...
public class VirtueStalwart extends AbstractPower implements CloneablePowerInterface {

    public static final String POWER_ID = DarkestMod.makeID("Stalwart");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;

    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("stalwart.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("virtue_power.png"));

    public VirtueStalwart(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = "Stalwart";
    ...
    public AbstractPower makeCopy() {
        return new VirtueStalwart(owner, amount);
    }
}
